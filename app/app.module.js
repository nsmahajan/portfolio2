...
var app_projectComponent_1 = require('./project/app.projectComponent');
        ...
        core_1.NgModule({
            imports: [platform_browser_1.BrowserModule,
                router_1.RouterModule.forRoot([
                    {
                        path: 'project',
                        component: app_projectComponent_1.ProjectComponent
                    },
                    {
                        path: '',
            ...
            declarations: [app_component_1.AppComponent,
                ...
                app_projectComponent_1.ProjectComponent,
